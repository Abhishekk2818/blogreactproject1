...
export const technology = createContext();
const Technologyapi = (props) => {
  const [dataTech, setDataTech] = useState([
      ...
      "author": null,
      "title": "Instagram is changing: From updated logo to new typeface; heres everything to know - The Financial Express",
      "description": null,
  ...
  return (
    <div>
      <technology.Provider value={[dataTech, setDataTech]}>
        {props.children}
      </technology.Provider>
    </div>
  );
